...
<head>
    ...
    <?php foreach ($linkTags as $link): ?>
        <link href="<?= htmlspecialchars($link['href'], ENT_QUOTES, 'UTF-8') ?>"
            title="<?= htmlspecialchars($link['title'], ENT_QUOTES, 'UTF-8') ?>" rel="alternate"
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="pagetitle">
            <a href="<?= htmlspecialchars($uri, ENT_QUOTES, 'UTF-8') ?>" target="_blank">
                <?= htmlspecialchars($title, ENT_QUOTES, 'UTF-8') ?>
            </a>
        </h1>
            ...
            <?php foreach ($buttons as $button): ?>
                <a href="<?= htmlspecialchars($button['href'], ENT_QUOTES, 'UTF-8') ?>">
                    <button class="rss-feed">
                        <?= htmlspecialchars($button['value'], ENT_QUOTES, 'UTF-8') ?>
                    </button>
                </a>
            <?php endforeach; ?>
        </div>
        ...
        <div class="item-container">
            <?php if ($item['title']): ?>
                <section class="feeditem">
                    <h2>
                        <a class="itemtitle" href="<?= e($item['url']) ?>">
            ...
            <div id="justified-gallery-<?= $index ?>" class="justified-gallery">
                <?php foreach ($item['galleryItems'] as $galleryItem): ?>
                    <a href="<?= htmlspecialchars($galleryItem['url'], ENT_QUOTES, 'UTF-8') ?>" class="gallery-item">
                        <img src="<?= htmlspecialchars($galleryItem['thumbnail'], ENT_QUOTES, 'UTF-8') ?>"
