...
class GalleryFormat extends FormatAbstract
{
    ...
    private function extractGalleryItems($item)
    {
        ...
        $itemTitle = $item->getTitle(); // Get the title of the item
        ...
        foreach ($tags as $tag) {
            ...
            $altText = $tag->getAttribute('alt'); // Extract the alt attribute
            ...
            if ($imageSrc) {
                $galleryItems[] = [
                    ...
                    'alt' => $altText ?: ($itemTitle ?: ''), // Use the item title as alt text if alt is not present and title exists
                ];
            }
        }
